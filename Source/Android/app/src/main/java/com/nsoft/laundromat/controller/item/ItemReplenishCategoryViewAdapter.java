...
public class ItemReplenishCategoryViewAdapter extends RecyclerView.Adapter<ItemReplenishCategoryViewAdapter.ViewHolder> {

    private List<String> categoryName;
    private ArrayList<OfferCategoryView> categoryViewArrayList;
    private LayoutInflater mInflater;
    private static ItemReplenishActivity.ItemClickListener mClickListener;

    // data is passed into the constructor
    public ItemReplenishCategoryViewAdapter(Context context, ArrayList<OfferCategoryView> categoryViewArrayList, ItemReplenishActivity.ItemClickListener itemClickListener) {
