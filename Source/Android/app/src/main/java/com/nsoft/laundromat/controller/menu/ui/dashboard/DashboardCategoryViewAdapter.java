...
public class DashboardCategoryViewAdapter extends RecyclerView.Adapter<DashboardCategoryViewAdapter.ViewHolder> {

    private List<String> categoryName;
    private ArrayList<DashboardCategoryView> categoryViewArrayList;
    private LayoutInflater mInflater;
    private static OfferFragment.ItemClickListener mClickListener;

    // data is passed into the constructor
    DashboardCategoryViewAdapter(Context context, ArrayList<DashboardCategoryView> categoryViewArrayList, OfferFragment.ItemClickListener itemClickListener) {
