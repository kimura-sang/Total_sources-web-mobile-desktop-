...
package com.nsoft.laundromat.controller.shop.scan.decoding;
...
public final class Intents {
  ...
  public static final class Scan {
     ...
     * intent.getStringExtra(RESULT). If the user presses Back, the result categoryName will be
     * RESULT_CANCELED.
     */
  ...
  public static final class Encode {
    /**
     * Send this intent to encode a piece of data as a QR categoryName and display it full screen, so
