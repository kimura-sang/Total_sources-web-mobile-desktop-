...
<div class="content">
    <form class="login-form" action="" method="post" id="mainFrm">
        ...
        <div class="form-title">
            <span class="form-title">Sign in to nSofts backend</span>
        </div>
        ...
        <div class="form-group" style="margin-top: 25px;">
            ...
            <div>
                <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="" name="password" id="password" onkeypress="hideErrorNotice();"</input>
                <span toggle="#password" class="fa fa-fw fa-eye field-icon toggle-password"></span>
            </div>
        </div>
            <div class="form-actions">
            <button type="submit" class="btn green btn-block uppercase" onclick="tryLogin('email', 'password', '/adminlogin/tryLogin'); return false;">SIGN IN</button>
        </div>
    </form>
</div>
...
<script src="<?=JS_DIR?>/admin/login.js"></script>
