...
<head>
    ...
    <link href="<?=ASSETS_DIR ?>/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css" />
    <link href="<?=ASSETS_DIR ?>/pages/css/profile.min.css" rel="stylesheet" type="text/css" />
    ...
    <script src="<?=ASSETS_DIR ?>/pages/scripts/dashboard.min.js" type="text/javascript"></script>
    ...
    <script src="<?=JS_DIR?>/frontend/shop.js"></script>
    <!---js--->
