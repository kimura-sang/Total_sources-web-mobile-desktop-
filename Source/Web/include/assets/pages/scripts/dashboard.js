var Dashboard = function() {
    ...
    return {
        ...
        initCharts: function() {
            ...
            var colors = ["#9ACAE6", "#cc0000", "#00cc00", "#00ffff"];

            for (var i = 0; i < 4; i++)
            {
                if ($('#site_activities' + i).size() != 0) {
                    //site activities
                    var previousPoint2 = null;
                    $('#site_activities_loading' + i).hide();
                    $('#site_activities_content' + i).show();
                    ...
                    var plot_statistics = $.plot($("#site_activities" + i),
                    ...
                    $("#site_activities" + i).bind("plothover", function(event, pos, item) {
                        $("#x").text(pos.x.toFixed(2));
                        $("#y").text(pos.y.toFixed(2));
                        if (item) {
                    ...
                    $('#site_activities' + i).bind("mouseleave", function() {
                        $("#tooltip").remove();
                    });
                }
            }
