//
//  AddShopNoticeTableViewCell.swift
//  nSoft
//
...
protocol AddShopNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}

class AddShopNoticeTableViewCell: UITableViewCell {
   ...
   var delegate:AddShopNoticeTableViewCellDelegate?
