...
protocol DashNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}
class DashNoticeTableViewCell: UITableViewCell {
       ...
       var delegate:DashNoticeTableViewCellDelegate?
