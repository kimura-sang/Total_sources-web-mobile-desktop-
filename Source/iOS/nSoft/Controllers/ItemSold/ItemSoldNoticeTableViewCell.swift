//
//  ItemSoldNoticeTableViewCell.swift
//  nSoft
//
...
import UIKit
protocol ItemSoldNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}
class ItemSoldNoticeTableViewCell: UITableViewCell {
       ...
       var delegate:ItemSoldNoticeTableViewCellDelegate?
