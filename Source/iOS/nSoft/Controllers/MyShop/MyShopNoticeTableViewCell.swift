//
//  MyShopNoticeTableViewCell.swift
//  nSoft
//
...
protocol MyShopNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}

class MyShopNoticeTableViewCell: UITableViewCell {
   ...
   var delegate:MyShopNoticeTableViewCellDelegate?
