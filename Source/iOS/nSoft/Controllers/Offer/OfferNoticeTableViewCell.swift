//
//  StaffNoticeTableViewCell.swift
//  nSoft
//
...
import UIKit
protocol OfferNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}
class OfferNoticeTableViewCell: UITableViewCell {
    ...
    var delegate:OfferNoticeTableViewCellDelegate?
