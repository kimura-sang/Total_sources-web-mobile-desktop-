//
//  ReplenishNoticeTableViewCell.swift
//  nSoft
//
...
protocol ReplenishNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}
class ReplenishNoticeTableViewCell: UITableViewCell {
    ...
    var delegate:ReplenishNoticeTableViewCellDelegate?
