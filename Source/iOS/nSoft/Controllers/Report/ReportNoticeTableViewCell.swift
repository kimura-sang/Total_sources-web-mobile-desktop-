//
//  ReportNoticeTableViewCell.swift
//  nSoft
//
...
protocol ReportNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}
class ReportNoticeTableViewCell: UITableViewCell {
       ...
       var delegate:ReportNoticeTableViewCellDelegate?
