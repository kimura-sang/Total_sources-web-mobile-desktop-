//
//  StaffProfileNoticeTableViewCell.swift
//  nSoft
//
...
protocol StaffProfileNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}
class StaffProfileNoticeTableViewCell: UITableViewCell {
        ...
        var delegate:StaffProfileNoticeTableViewCellDelegate?
