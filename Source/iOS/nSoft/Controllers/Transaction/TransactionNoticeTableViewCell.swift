//
//  TransactionShopTableViewCell.swift
//  nSoft
//
...
protocol TransactionNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}
class TransactionNoticeTableViewCell: UITableViewCell {
    ...
    var delegate:TransactionNoticeTableViewCellDelegate?
