//
//  UserInfoNoticeTableViewCell.swift
//  nSoft
//
...
protocol UserInfoNoticeTableViewCellDelegate {
    func hideNotice(noticeNo:String)
    func activeNotice(noticeNo:String)
}
class UserInfoNoticeTableViewCell: UITableViewCell {
     @IBOutlet weak var btnHide: UIButton!
       ...
       var delegate:UserInfoNoticeTableViewCellDelegate?
